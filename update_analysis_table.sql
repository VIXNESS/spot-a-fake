-- SQL commands to update existing analysis table in Supabase
...
COMMENT ON COLUMN analysis.ai_confidence IS 'AI confidence score (0.0000 to 1.0000)';
COMMENT ON COLUMN analysis.ai_result_text IS 'AI analysis result text';

-- Optional: Create an index on ai_confidence if you plan to query/filter by confidence levels
-- CREATE INDEX idx_analysis_ai_confidence ON analysis(ai_confidence);
